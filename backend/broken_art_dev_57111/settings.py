"""
Django settings for broken_art_dev_57111 project.
...
ROOT_URLCONF = 'broken_art_dev_57111.urls'
...
WSGI_APPLICATION = 'broken_art_dev_57111.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_art_dev_57111 API",
    "DESCRIPTION": "API documentation for broken_art_dev_57111 App",
    "VERSION": "v1",
}
